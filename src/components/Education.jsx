            ...
            <div className="flex flex-wrap">
                ...
                <motion.div 
                    ...
                    <div className="ml-auto mr-20">
                        <p className="mt-2 max-w-xl py-6 text-2xl">George Mason University</p>
                        ...
                        <div className="flex max-w-3xl py-4 text-neutral-400">
                            <p><span className="font-bold text-purple-100">Relevant Coursework:</span>{COURSES}</p>
                        </div>
